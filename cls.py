...
if __name__ == '__main__before':
    ...
    json_file_list = glob.glob('./R5_data/val/**/*.json', recursive=True)
    json_list_name = [os.path.splitext(os.path.basename(i))[0].replace('_viz', '') for i in json_file_list]
    all_reflectance_file_list = glob.glob('/home/kevin/temp/temp/**/results/*.tif', recursive=True)
...
if __name__ == '__main__':
    ...
    all_reflectance_file_list = glob.glob('/home/kevin/temp/temp/**/results/*.dat', recursive=True)
